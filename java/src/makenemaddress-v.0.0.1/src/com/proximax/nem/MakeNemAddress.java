...
public class MakeNemAddress {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String newNem = (new MakeNemAddress()).getNewNemAddress(args[0]);
        System.out.println(newNem);
        System.exit(0);
    }

    public String getNewNemAddress(String uid) throws ApiException, InterruptedException, ExecutionException, InsufficientAmountException {
